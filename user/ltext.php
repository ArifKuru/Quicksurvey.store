...
<head>
    ...
    <style>
        ...
        .input-container {
            ...
            flex-direction: column;
            gap: 10px;
            overflow-y: auto; /* Allow vertical scroll in the input container */
        }
        ...
        textarea {
            ...
            border-radius: 5px;
            box-sizing: border-box;
            min-height: 220px; /* Minimum height to keep text box proportionate */
            max-height: 250px; /* Limit height of the input box */
            overflow-y: auto; /* Allow vertical scroll if the content exceeds max-height */
        }
        ...
        @media (max-width: 576px) {
            ...
            .survey-container {
                ...
                height: 462px; /* Allow height to adjust dynamically */
                padding: 15px;
            }
...
<div class="survey-container">
    ...
    <div class="input-container">
        <textarea name="value" rows="10" placeholder="Type here your answer!"></textarea>
    </div>
